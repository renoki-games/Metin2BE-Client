			...
			(
				{
					...
					"x" : 4, "y" : 32,
					"text" : localeInfo.HELP_MOUSE_LEFT,
					"text_horizontal_align" : "center",
				},
			),
		},
			...
			(
				{
					...
					"x" : 4, "y" : 32,
					"text" : localeInfo.HELP_MOUSE_RIGHT,
					"text_horizontal_align" : "center",
				},
			),
		},
			...
			(
				{
					...
					"x" : 4, "y" : 51,
					"text" : localeInfo.HELP_QUICKSLOT,
					"text_horizontal_align" : "center",
				},
			),
		},
			...
			(
				{
					...
					"x" : 4, "y" : -20,
					"text" : localeInfo.HELP_SYSTEM_BUTTON,
					"text_horizontal_align" : "center",
				},
				{
					"name" : "taskbar_help_08b", "type" : "text",
					"x" : 4, "y" : -5,
					"text" : localeInfo.HELP_CHARACTER_BUTTON1,
					"text_horizontal_align" : "center",
				},
				{
					"name" : "taskbar_help_08c", "type" : "text",
					"x" : 4, "y" : 10,
					"text" : localeInfo.HELP_CHARACTER_BUTTON2,
					"text_horizontal_align" : "center",
				},
			),
		},
